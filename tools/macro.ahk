...
Gui, Margin, 0, 0
Gui, Font, s12
s:="Record(Screen),Record(Window),Stop,Play,Edit, Pause "
...
Run:
if IsLabel(k:=RegExReplace(A_GuiControl,"\W"))
    Goto, %k%
    return
                                                                                          ...
                                                                                          title:=SubStr(title,1,-1)
                                                                                              ...
                                                                                              title.=class ? " ahk_class " class : ""
                                                                                                title:=RegExReplace(Trim(title), "[``%;]", "``$0")
                                                                                                  s:="WinWait, " title ",, 5`nWinActivate, " title
                                                                                                    i:=LogArr.MaxIndex(), r:=LogArr[i]
                                                                                                      if InStr(r, "WinWait")
                                                                                                            LogArr[i]:=s, Log()
                                                                                                              else
